...
import { bookingPolicies, getRoomBySlug, getRoomBookings, rooms } from "@/lib/data";
...
export default async function RoomDetailPage({ params }: RoomDetailPageProps) {
  ...
  const roomBookings = getRoomBookings(room.slug);
          ...
          <div className="space-y-6">
            ...
            <Card className="glass-panel">
              <CardHeader>
                ...
                <CardDescription>Contoh booking terkait ruangan ini untuk membantu validasi desain list dan status.</CardDescription>
              </CardHeader>
                ...
                {roomBookings.map((booking) => (
                  <div key={booking.id} className="rounded-[24px] bg-background/70 p-4">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      Surat: {booking.requestLetterName}
                    </p>
                  </div>
                ))}
              </CardContent>
